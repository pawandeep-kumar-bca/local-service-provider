...
router.get(
  ...
  roleBased("admin"),
  adminController.getProvidersByAdmin,
);
...
router.get(
  ...
  authMiddleware.tokenVerify,
  roleBased("admin"),
  adminController.pendingProviders,
);
...
router.put(
  ...
  roleBased("admin"),
  validateObjectId("id"),
  adminController.pendingProvidersApproved,
);
...
router.put(
  ...
  roleBased("admin"),
  validateObjectId("id"),
  adminController.pendingProvidersReject,
);
