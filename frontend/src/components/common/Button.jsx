const Button = ({
  ...
  const base =
    "py-2 px-5 flex items-center gap-2 font-roboto rounded-[4px] cursor-pointer font-bold shadow-md transition-all inset-shadow-xs duration-200 disabled:opacity-50 disabled:cursor-not-allowed text-lg sm:text-sm hover:scale-105 shadow-lg active:scale-95";
