const Button = ({
  ...
  const base =
    "py-2 px-4 flex items-center justify-center gap-2 font-roboto rounded-[4px] cursor-pointer font-base shadow-md transition-all inset-shadow-xs duration-200 disabled:opacity-50 disabled:cursor-not-allowed md:text-lg hover:scale-105 shadow-lg active:scale-95";
