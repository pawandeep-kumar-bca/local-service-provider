...
const submitForm = (e)=>{
   ...
   createProviderMutation.mutate({
    providerName,phoneNumber,experience,price,state,district,city,village,serviceCategory
   })
   setProviderName('')
   setCity('')
   setPhoneNumber('')
      ...
      "
            ...
            >
              ...
              </option>
              {
               ...
               {
                categories?.map((category)=><option key={category._id} value={category._id}> {category.name.charAt(0).toUpperCase() + category.name.slice(1)}</option>)
               }
