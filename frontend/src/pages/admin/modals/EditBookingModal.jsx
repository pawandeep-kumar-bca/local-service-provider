    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold text-slate-800">Edit Booking</h1>
        ...
        <div className="mt-5 flex items-center justify-end gap-3">
          <Button color="white" onClick={close} className="min-w-[110px]">
            Cancel
          </Button>

          <Button color="blue" className="min-w-[140px]">
            Save Changes
          </Button>
        </div>
      </div>
