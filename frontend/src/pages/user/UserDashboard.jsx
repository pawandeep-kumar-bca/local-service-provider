...
const UserDashboard = () => {
  ...
  shadow-[0_8px_30px_rgba(0,0,0,0.5)] flex justify-between items-start mt-3"
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-4 mb-6">
      ...
      <Cards icon={<FaWallet className="text-success text-2xl"/>} value={3}>Total Earning</Cards>
      <Cards icon={<FaCheckCircle className="text-primary text-2xl"/>} value={3}>Completed</Cards>
      <Cards icon={<FaCheckCircle className="text-divider text-2xl"/>} value={3}>Active</Cards>
      <Cards icon={<FaStar className="text-warning text-2xl"/>} value={3}>Reviewed</Cards>
      </div>
    </div>
    ...
    <div className="px-3">
        <div className="flex justify-between items-center">
            ...
            <Link to='/providers' className="text-primary">View All</Link>
        </div>
