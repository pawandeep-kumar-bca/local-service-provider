...
//     form.append("bookingDate", formData.bookingDate);
//     form.append("bookingSlot.startTime", formData.startTime);
//     form.append("bookingSlot.endTime", formData.endTime);
//   };
...
//             <Button color="blue" type="button" className="w-full md:w-auto">
