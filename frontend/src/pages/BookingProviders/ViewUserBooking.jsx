  ...
  return (
    <>
      <div className="md:shadow-[inset_0_0_4px_rgba(0,0,0,0.54)] rounded-xl md:p-4 min-h-[calc(100vh-110px)] overflow-hidden">
        <ViewProviderBookingDetails layout="row" bookingData={bookingData} />
      ...
      {cancel === "confirm" && <CancelConfirmedBooking setCancel={setCancel} />}

      {/* Cancel Success Modal */}

      {cancel === "success" && <CancelBooking setCancel={setCancel} />}
    </>
  );
};
